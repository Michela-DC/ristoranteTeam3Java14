...
public class Main {
    public static void main(String[] args) {
      ...
      // List.of() lo usiamo per creare una lista di allergeni che prendiamo da AllergeniEnum
        //Antipasti
        Portata polentinaConcia = new Antipasti("Polentina Concia" , 6.50 , "Polenta morbida al burro e fontina con sbriciolata di prosciutto crudo essicato", List.of(AllergeniEnum.LATTE));
        Portata tartareDiManzo = new Antipasti("Tartare di manzo" , 10.50 , "Con cremoso al pecorino, funghi pleius scottati e polvere di porcino essiccato", List.of(AllergeniEnum.LATTE));
        ...
        Portata bresaolaRucolaParmigiano = new Antipasti("Bresaola con rucola e parmigiano" , 8.50 , "Sottili fette di carne di manzo essiccata servite con rucola e scaglie di parmigiano", List.of(AllergeniEnum.LATTE));
